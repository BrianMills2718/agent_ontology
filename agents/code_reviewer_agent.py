#!/usr/bin/env python3
"""
Code Review Agent — Generated by Agent Ontology Instantiation Engine
...
def process_analyze_security(state):
    ...
    state.schema_violations += len(validate_output(security_reviewer_result, "SecurityReview"))
...
def process_analyze_style(state):
    ...
    # Validate and merge output fields into state.data
    state.schema_violations += len(validate_output(style_reviewer_result, "StyleReview"))
...
def process_analyze_logic(state):
    ...
    # Validate and merge output fields into state.data
    state.schema_violations += len(validate_output(logic_reviewer_result, "LogicReview"))
...
def process_synthesize_review(state):
    ...
    # Validate and merge output fields into state.data
    state.schema_violations += len(validate_output(lead_reviewer_result, "SynthesizedReview"))
